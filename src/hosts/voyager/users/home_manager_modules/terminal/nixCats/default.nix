  ...
  config = {
    ...
    nixCats = {
      ...
      packageDefinitions.replace = {
        nixCats = {pkgs, ...}: {
          settings = {
            unwrappedCfgPath = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/nixc/src/hosts/voyager/users/home_manager_modules/terminal/nixCats/dotfiles";
            aliases = ["vim" "homeVim"];
          };
